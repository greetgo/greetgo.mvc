...
public final class SecurityTunnelWrapper implements TunnelHandler {
  ...
  public void handleTunnel(final RequestTunnel tunnel) {
    ...
    if (trace != null) {
      trace.trace("underSecurityUmbrella = " + underSecurityUmbrella);
    }
    ...
    
    {
      ...
      if (trace != null) {
        trace.trace("CP HEBWJD bytes " + (bytes == null ? "is null" :" is not null"));
      }
    ...
    final EventHandler writeSessionToCookies = new EventHandler() {
      ...
      public void handle() {
        ...
        if (trace != null) {
          trace.trace("CP 543nj654 " + (bytes == null ? "bytes is null" :"bytes is not null"));
        }
