...
public class SecuritySourceOnFiles extends AbstractSecuritySource {
  ...
  public SecuritySourceOnFiles(int keySize, int blockSize, 
  ...
  public SecuritySourceOnFiles(File privateKeyFile, File publicKeyFile) {
    this(DEFAULT_KEY_SIZE, DEFAULT_BLOCK_SIZE, privateKeyFile, publicKeyFile, new SecuritySourceConfigDefault());
  }
