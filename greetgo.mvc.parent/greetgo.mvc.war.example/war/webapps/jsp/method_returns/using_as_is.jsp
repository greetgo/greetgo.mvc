...
<div id="using-as-is" class="example-container">
  <h3 class="title">Using @AsIs</h3>
  ...
  <script>(function () {
    ...
    var requestUriBase = "${contextPath}/api/method_returns/using-as-is";

    var self = $("#using-as-is");
