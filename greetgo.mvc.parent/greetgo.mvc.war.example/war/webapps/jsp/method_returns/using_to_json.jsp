...
<div id="using-to-json" class="example-container">
  <h3 class="title">Using @ToJson</h3>
  ...
  <script>(function () {
    ...
    var requestUriBase = "${contextPath}/api/method_returns/using-to-json";

    var self = $("#using-to-json");
