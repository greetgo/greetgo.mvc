...
<style>
  #par-session-example .err {
    border: 1px solid red;
  }
</style>

<div id="par-session-example" class="example-container">
  <h3 class="title">@ParSession Example</h3>
  ...
  <script>(function () {
    ...
    var requestUriBase = "${contextPath}/api/request_parameters/par-session-example";

    var self = $("#par-session-example");
