 ...
 * <p/>
 * <p/>
 * MultipartInjectionHandler ensures that the parts are deleted after the
 ...
 * {@link #handle(String, Request, HttpServletRequest, HttpServletResponse)}.
 */
public class MultipartInjectionHandler extends HandlerWrapper {
  ...
  public static boolean isMultipartRequest(ServletRequest request) {
    return request.getContentType() != null
      && request.getContentType().startsWith(MULTIPART_FORM_DATA_TYPE);
  }
