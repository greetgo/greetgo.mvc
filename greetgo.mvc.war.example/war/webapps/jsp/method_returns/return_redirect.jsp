...
<div id="return-redirect" class="example-container">
  <h3 class="title">Return Redirect</h3>
  <table>
    <tbody>
    <tr>
      <td>param</td>
  ...
  <script>(function () {
    ...
    var requestUriBase = "${contextPath}/api/method_returns/return-redirect";

    var self = $("#return-redirect");
