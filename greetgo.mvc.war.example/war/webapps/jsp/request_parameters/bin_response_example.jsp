...
<style>
  #bin-response-example .err {
    border: 1px solid red;
  }
</style>

<div id="bin-response-example" class="example-container">
  <h3 class="title">BinResponse Example</h3>
  ...
  <script>(function () {
    ...
    var requestUriBase = "${contextPath}/api/request_parameters/download-a-file";

    var self = $("#bin-response-example");
